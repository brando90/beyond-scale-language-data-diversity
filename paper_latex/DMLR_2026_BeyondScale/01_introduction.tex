...
Current trends in pre-training Large Language Models (LLMs) tend to concentrate on model and dataset size scaling \citep{chowdhery2022palm, nostalgebraist2022chinchilla, gpt4, google2023palm2}.
...
However, the effectiveness of these systems also fundamentally relies on the quality \citep{longpre2023pretrainer}, variability and coverage of the pre-training data \citep{tatsu, david2010impossibility} and not only the \textit{size}. 
...
However, data quality, diversity and coverage \citep{david2010impossibility} are often discussed in vague and imprecise ways \citep{longpre2023pretrainer}. 
...
\begin{enumerate}
    ...
    \item We quantitatively demonstrate that public datasets for LLM pre-training exhibit \textit{high} diversity by comparing them to well-motivated lower and upper bounds for our diversity metric.
